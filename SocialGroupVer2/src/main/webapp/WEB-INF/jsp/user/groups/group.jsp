              ...
              <ul id="hmenu" class="sf-menu sf-js-enabled sf-shadow">
                ...
                <li>
                  <a class="toplvl" href="#">Search </a>
                  	<ul>
                  	<li>
                  	<a href = "../search/allPublic.html">View Public Groups</a>
                  	</li>
                  	<li>
                  	<a href = "../search/search.html">Search by..</a>
                  	</li>
...
<!--                   </div> -->
                  <div class="sidebox1">
                    ...
                    <div class="vmenu">
                    <ul>
                    <c:forEach items="${friends}" var = "friends" varStatus="status">
                    <li>
                    -- <a href ="../viewfriend.html?fdId=${friends.id}" > ${friends.firstName} ${friends.lastName}</a> --
                    <c:if test="${isOwner eq true }">
                    <form  class ="unfriend" action="unfriend.html" method="GET">  
                   <input type ="hidden" name="unfriend" value="${friends.id}">
              ...
              <div id="main">
                ...
                <center><h1>${group.groupName}</h1></center>
                <center><h2>Timeline</h2></center>
                
                <ul>
                <c:forEach items="${group.commets}" var="comment" varStatus="status">
                <section class = "comments c">
                
                <li>
                <b>${comment.postedById.firstName}</b> commented 
                <hr>
                </li>
                <li>
                ${comment.post}
                ...
                <tr><td>
					<textarea class="textbox" name = "posted"></textarea>
					</td>
					</tr>
					...
					<input type="hidden" value="${group.id}" name="groupId">
                 	<button style="align:right"type="submit" name="submit" value="post"> Post </button>
