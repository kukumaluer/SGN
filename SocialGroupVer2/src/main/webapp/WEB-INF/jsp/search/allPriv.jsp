            ...
            <div id="page">
              <div id="main">
                <div class="content">
                 ...
                 <a href = "../user/groups/group.html?groupId=${all.id}">  ${all.groupName} </a> - Created by<a href = "../user/viewProfile.html?userId=${all.ownerId.id}" > ${all.ownerId.firstName} ${all.ownerId.lastName} </a> 
