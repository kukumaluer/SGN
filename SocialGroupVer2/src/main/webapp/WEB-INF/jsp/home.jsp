                ...
                <c:when test="${empty user }">
                  ...
                  <a href="logout.html" class="toplvl">Logout</a>
                    ...
                    <c:when test="${empty user }">
                      ...
                      <c:otherwise>
                      <a href="user/profile.html" class="toplvl" >Profile</a>
                      </c:otherwise>
                      </c:choose>
                    </li>
                <li>
...
<!-- <a href="NewAcc.html"> Create Account </a> -->

<!-- <img src="images/blue_group.png" width="150" height="100"> -->
<!-- <img src="images/4amigos-logo.png" width="150" height="100"> -->
</body>
</html>